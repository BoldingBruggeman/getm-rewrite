...
sim = pygetm.Simulation(domain, runtype=4, advection_scheme=1, gotm=os.path.join(getm_setups_dir, 'NorthSea/gotmturb.nml'), fabm='../../extern/fabm/testcases/fabm-jrc-med_ergom.yaml')
