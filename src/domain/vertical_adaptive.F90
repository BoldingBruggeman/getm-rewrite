...
!! need to pass uu,vv,SS,NN
!! @endnote

SUBMODULE (getm_domain : vertical_coordinates_smod) vertical_adaptive_smod
...
!-----------------------------------------------------------------------------
   if (associated(self%logs)) call self%logs%info('do_adaptive()',level=3)
write(*,*) 'do_adaptive - has not been tested yet'
#if 0
...
END SUBMODULE vertical_adaptive_smod
